...
export const SearchBoxPC = (): React.JSX.Element => {
  ...
  return (
    <form
      className="z-0 hidden pc:flex w-[57%] items-center"
      method="GET"
      onSubmit={handleSubmit}
    >
      <svg
        className="text-[#9CB395] absolute translate-x-2.5"
        width="28"
        height="28"
      >
        <path
      ...
      <input
        className="focus:outline-none flex w-[100%] h-11 pr-3.5 pl-[61px] border-[2px] rounded-10px border-lightGreen placeholder:text-[#E2E4E5]"
        value={keyword}
        type="search"
