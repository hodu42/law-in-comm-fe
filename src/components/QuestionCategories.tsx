...
export const QuestionCategories = ():React.JSX.Element => {
    const categories = [
        ...
        { label: LegalSpecialityLabels.PROPERTY_CRIMES_EMBEZZLEMENT, value: "PROPERTY_CRIMES_EMBEZZLEMENT" },
        ...
        { label: LegalSpecialityLabels.TRAFFIC_ACCIDENT_HIT_RUN, value: "TRAFFIC_ACCIDENT_HIT_RUN" },
        { label: LegalSpecialityLabels.ASSAULT_DEFAMATION, value: "ASSAULT_DEFAMATION" }
    ];
