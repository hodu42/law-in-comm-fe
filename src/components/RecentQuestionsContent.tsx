...
export const RecentQuestionsContent = ({
  ...
  return (
    <Link
      ...
      className="block w-full min-h-[250px] pc:w-[80%] pc:h-[396px] bg-white hover:bg-[#F5F5F5] rounded-[10px] mx-auto p-[20px] pc:p-[30px] border-2 border-[#5C6E56] transition-all relative"
    >
