...
export const RecentQuestionsContent = ({
  ...
  return (
    <Link
      ...
      className="block w-[350px] min-h-[250px] pc:w-[848px] pc:h-[396px] bg-white hover:bg-[#F5F7F3] rounded-[10px] mx-auto p-[20px] pc:p-[30px] border-2 border-[#5C6E56] transition-all relative"
    >
