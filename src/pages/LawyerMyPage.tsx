...
export const LawyerMyPage = (): React.JSX.Element => {
  ...
  const loadAnswers = async (currentPage: number) => {
    const response = await getLawyerAnswers(Number(paramsUserId), currentPage);
      ...
      <main className="container mx-auto mt-[72px] px-4 pb-20 flex-grow">
        <div className="flex flex-col justify-between max-w-[700px] mx-auto mt-10">
          ...
          <div className="flex flex-col items-center w-full gap-10">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 text-[15px]">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#555]">{lawyerData?.birthDate}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <svg
                      className="w-5 h-5 text-[#B4B4B4]"
            ...
            {/* 분야/경력/학력 */}
            <div className="flex flex-col w-full justify-center gap-4 bg-white rounded-lg border border-[#E0E0E0] p-10">
              <div className="flex flex-col w-full gap-7 text-[15px] pc:text-[17px]">
                <div className="flex flex-col gap-2">
                  <span className="font-bold w-12 text-[18px] pc:text-[20px] inline-block whitespace-nowrap">
                    분야
                  </span>
              ...
              {currentUserId && currentUserId === Number(paramsUserId) && (
                <Link
                  ...
                  className="w-28 text-center mx-auto bg-[#CBD8B7] text-black font-bold text-[15px] pc:text-[16px] py-2 rounded-md hover:bg-[#A9BE8C] transition-colors"
                >
                  내 정보 수정
                </Link>
              )}
