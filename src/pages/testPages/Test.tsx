...
export const Test = (): React.JSX.Element => {
  ...
  const [userInfo, setUserInfo] = React.useState<RegisterLawyerInfo | null>(
    null
  );
  ...
  return (
    <div className="flex flex-col gap-10px">
      ...
      <button className="bg-green-500" onClick={fetchLawyerSpeciality}>
        테스트
      </button>
      <div>
        <h1>닉네임 중복체크</h1>
