...
export const PendingLawyersPage = ():React.JSX.Element => {
    ...
    const fetchDetailedPendingLawyer = async (e:React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        try {
                ...
                </form>
                {
                    detailedPendingLawyer && (
                        <div className="border-2 border-lightGreen rounded-10px flex flex-col">
                            ...
                            <img src={`${IMAGE_URL}${detailedPendingLawyer.licenseImageInfo.path}`} alt="자격증 이미지" className="w-32 h-32 object-cover rounded-full"/>
