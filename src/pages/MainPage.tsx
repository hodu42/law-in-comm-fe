...
export const MainPage = (): React.JSX.Element => {
  ...
  return (
    <>
      ...
      <div className="w-[90%] pc:hidden flex justify-between px-4">
        <Link
          to="/question/write"
          className="w-[40%] flex justify-evenly items-center bg-[#C9D8B7] px-1 py-1 rounded-10px"
        >
          <svg
            className="text-[#5C6E56] w-8 h-8"
            width="100%"
            height="100%"
            viewBox="0 0 40 40"
          >
          ...
          <span className="inline-block text-black text-center text-[16px] pc:text-[18px] font-bold truncate">
            질문 작성
          </span>
        </Link>
        <Link
