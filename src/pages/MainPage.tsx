...
export const MainPage= ():React.JSX.Element => {
    return (
        <div className="flex flex-col items-center bg-[#F7F7FA]">
            <MainHeader/>
            <MobileSearch/>
            <RecentQuestions/>
            <div className="min-[740px]:hidden w-[90%] flex justify-between px-[20px]">
                <a href="#" className="w-[155px] flex justify-evenly items-center bg-[#C9D8B7] px-[10px] py-[5px] rounded-10px">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none"><path fill="#5C6E56" d="M21.667 10 30 18.333 14.155 34.178a2.943 2.943 0 0 1-.02-4.141l-.005-.005a2.94 2.94 0 0 1-4.202-4.112l-.013-.013a2.942 2.942 0 0 1-4.092-.06L21.667 10Zm12.643-.69-3.62-3.62a3.333 3.333 0 0 0-4.713 0l-2.644 2.643 8.334 8.334 2.643-2.644a3.333 3.333 0 0 0 0-4.713ZM5 30v5h5a5 5 0 0 0-5-5Z"/></svg>
                    <span className="inline-block text-black text-center text-[18px] font-bold">질문 작성</span>
                </a>
                <a href="#" className="w-[155px] flex justify-evenly items-center bg-[#C9D8B7] px-[10px] py-[5px] rounded-10px">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none"><path fill="#5C6E56" fill-rule="evenodd" d="M5.417 11.667a1.25 1.25 0 0 1 1.25-1.25h26.666a1.25 1.25 0 0 1 0 2.5H6.667a1.25 1.25 0 0 1-1.25-1.25Zm0 8.333a1.25 1.25 0 0 1 1.25-1.25H25a1.25 1.25 0 1 1 0 2.5H6.666A1.25 1.25 0 0 1 5.416 20Zm0 8.333a1.25 1.25 0 0 1 1.25-1.25H15a1.25 1.25 0 1 1 0 2.5H6.666a1.25 1.25 0 0 1-1.25-1.25Z" clip-rule="evenodd"/></svg>
