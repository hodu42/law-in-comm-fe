...
export const MainPage= ():React.JSX.Element => {
    return (
        <div className="main-container flex flex-col items-center bg-[#F7F7FA]">
            ...
            <MobileSearch/>
            <RecentQuestions/>
            <div className="w-[90%] mobile:hidden flex justify-between px-[20px]">
                ...
                <a href="/question/list" className="w-[155px] flex justify-evenly items-center bg-[#C9D8B7] px-[10px] py-[5px] rounded-10px">
