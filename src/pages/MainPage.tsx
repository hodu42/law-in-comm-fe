    ...
    return (
        <div className="main-container flex flex-col items-center bg-[#F7F7FA]">
            ...
            <div className="w-[90%] pc:hidden flex justify-between px-[20px]">
                <Link to="/question/write" className="w-[155px] flex justify-evenly items-center bg-[#C9D8B7] px-[10px] py-[5px] rounded-10px">
                ...
                <Link to="/questions?keyword=&category=&page=0" onClick={clearKeyword} className="w-[155px] flex justify-evenly items-center bg-[#C9D8B7] px-[10px] py-[5px] rounded-10px">
