...
export const Login = (): React.JSX.Element => {
  ...
  return (
    <div className="flex flex-col min-h-screen items-center bg-white">
      {/* 헤더 영역 */}
      <header className="relative min-w-[355px] max-w-[1350px] w-[70.31%] h-[72px] flex items-center">
        {/* 데스크탑 로고 */}
      ...
      {/* 메인 콘텐츠 */}
      <div className="flex flex-col w-full flex-grow px-6 items-center">
        <div className="flex flex-col w-full mobile:max-w-[570px] mobile:mx-auto mt-10 mobile:mt-16 gap-y-20 px-6 py-10 border-b-[1.7px] border-[#B4B4B4]">
          {/* 아이디 입력 필드 */}
          <div className="flex flex-col">
            <label className="text-[#656565] mobile:text-gray-600 text-lg font-bold mb-6">
              아이디
            </label>
            <input
              type="text"
              placeholder="아이디를 입력해주세요."
              className="border-b-2 pl-4 placeholder:text-[19px] text-[19px] border-[#E2E4E5] py-4 focus:outline-none focus:border-[#A9BE8C] placeholder-[#E2E4E5]"
              value={userId}
        ...
        {/* 회원가입 링크 */}
          <div className="flex w-[570px] justify-evenly my-[50px]">
            <span className="font-NotoSansKR text-[20px]">아직 회원이 아니신가요?</span>
            <Link to="/register" className="font-NotoSansKR text-[20px] text-[#A9BE8C] font-bold">
              회원가입
            </Link>
          </div>
      </div>
