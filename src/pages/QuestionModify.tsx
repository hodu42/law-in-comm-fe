...
import { LegalSpecialityLabels, LegalSpeciality } from '@/types/speciality';
import { Question } from '@/types/question';

export const QuestionModify = (): React.JSX.Element => {
    ...
    const changePrevQuestion = (updates:Partial<Question>) => {
        ...
        <div className="flex flex-col min-h-screen bg-gray-50 question-form-container">
            ...
            <header className="fixed shadow-md top-0 left-0 right-0 w-full h-[72px] flex items-center justify-center bg-white z-20">
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    {/* 모바일 뒤로가기 버튼 */}
                    <button onClick={() => navigate(-1)} className="pc:hidden flex items-center text-black z-10">
                    ...
                    <button onClick={handleSubmit} className="hidden pc:flex items-center group">
                        ...
                        <span className="text-[#9CB395] text-[21px] font-bold ml-2 group-hover:text-[#7D9277]">수정하기</span>
                    </button>
                    {/* 모바일 등록하기 버튼 */}
                    <button onClick={handleSubmit} className="pc:hidden items-center bg-[#C9D8B7] text-black px-4 py-2 rounded-[10px] text-nowrap text-[16px] hover:bg-[#A9BE8C] font-medium">수정</button>
                </div>
            </header>
            ...
            <main className="flex-grow container mx-auto px-4 py-12 mt-[72px]">
                <form className="max-w-3xl mx-auto">
                    <div className="mb-6">
                        <label htmlFor="title" className="block text-[20px] font-medium mb-2">제목</label>
                        <input
                            type="text"
                            id="title"
                    ...
                    <div className="mb-6">
                        <label htmlFor="category" className="block text-[20px] font-medium mb-2">분야</label>
                    ...
                    <div className="mb-6">
                        <label htmlFor="eventDate" className="block text-[20px] font-medium mb-2">최초 사건 발생일자</label>
                        <div className="relative">
                            <input
                                type="date"
                                id="eventDate"
                    ...
                    <div className="mb-6">
                        <label htmlFor="content" className="block text-[20px] font-medium mb-2">내용</label>
                        <textarea
                            id="content"
                            rows={8}
                    ...
                    <div className="flex justify-end items-center mb-6">
                        <label htmlFor="anonymous" className="mr-2 text-[18px]">익명으로 작성</label>
                        <input
                            type="checkbox"
                            id="anonymous"
                            checked={question?.anonymous || false}
                            onChange={(e) => changePrevQuestion({anonymous: e.target.checked})}
