    ...
    <div className="flex flex-col min-h-screen bg-gray-50 question-form-container">
      ...
      <header className="fixed shadow-md top-0 left-0 right-0 w-full h-[72px] flex items-center justify-center bg-white z-20">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          >
            <svg
              className="text-[#9CB395] group-hover:text-[#7D9277]"
            ...
            <span className="text-[#9CB395] text-[21px] font-bold ml-2 group-hover:text-[#7D9277]">
              수정하기
            </span>
          </button>
          {/* 모바일 등록하기 버튼 */}
          <button
            onClick={handleSubmit}
            className="pc:hidden items-center bg-[#C9D8B7] text-black px-4 py-2 rounded-[10px] text-nowrap text-[16px] hover:bg-[#A9BE8C] font-medium"
          >
            수정
          </button>
        </div>
        ...
        <form className="max-w-3xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <select
                ...
                onChange={(e) =>
                  changePrevQuestion({
                    legalSpeciality: e.target.value as LegalSpeciality,
                  })
                }
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) =>
                  changePrevQuestion({ firstOccurrenceDate: e.target.value })
                }
          ...
          <div className="flex justify-end items-center mb-6">
            ...
            <input
              ...
              onChange={(e) =>
                changePrevQuestion({ anonymous: e.target.checked })
              }
